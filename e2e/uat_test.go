...
func TestUAT1_Mijeong_JuniorDevOps(t *testing.T) {
	...
	status, resp = doRequest(t, http.MethodPost, "/api/v1/stacks/estimate", map[string]any{
		"artifacts": map[string]any{
			"source_repository":  map[string]any{"name": "gitlab-ce", "version": "16.11", "enabled": true},
			"container_registry": map[string]any{"name": "harbor", "version": "2.10", "enabled": true},
		},
		"pipeline": map[string]any{
			"ci_platform": map[string]any{"name": "gitlab-ci", "version": "16.11", "enabled": true},
			"cd_tool":     map[string]any{"name": "argocd", "version": "2.11", "enabled": true},
		},
		"monitoring": map[string]any{
			"collection":    map[string]any{"name": "prometheus", "version": "2.52", "enabled": true},
			"visualization": map[string]any{"name": "grafana", "version": "10.4", "enabled": true},
		},
		"logging": map[string]any{
			"collection": map[string]any{"name": "fluent-bit", "version": "3.0", "enabled": true},
			"search":     map[string]any{"name": "opensearch", "version": "2.14", "enabled": true},
		},
