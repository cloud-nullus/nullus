...
func newEchoServer() *echo.Echo {
	...
	stackHandler := stackhandler.NewStackHandler(createStackUC, listStacksUC, deleteStackUC, addToolsUC, memStackRepo, nil, stackhandler.WithHistory(manageHistoryUC))
