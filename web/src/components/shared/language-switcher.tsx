...
export function LanguageSwitcher({
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isActive
                  ? 'bg-[color-mix(in srgb, var(--color-brand-gold) 16%, transparent)] text-[var(--color-brand-gold)]'
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div className="absolute top-10 right-0 z-10 min-w-[164px] overflow-hidden rounded-[10px] border border-[var(--color-border-default)] bg-[var(--color-surface-card)] shadow-[0_12px_28px_color-mix(in srgb, var(--color-text-primary) 35%, transparent)]">
          {LANGUAGE_OPTIONS.map((option) => {
            const isActive = currentOption.code === option.code
            return (
              <button
                ...
                className={cn(
                  ...
                  isActive
                    ? 'bg-[color-mix(in srgb, var(--color-brand-gold) 14%, transparent)] text-[var(--color-brand-gold)]'
