...
export type ToolCategory = ToolCategoryDefinition
...
export const ESTIMATE_BASE_MINUTES = 5
export const DISPLAY_ESTIMATE_MIN_MINUTES = 10
export const DISPLAY_ESTIMATE_MAX_MINUTES = 19
...
export const TOOL_BONUS_MINUTES: Record<string, number> = {
  'gitlab ce': 2,
  jenkins: 4,
  thanos: 4,
  'victoria metrics': 3,
...
export const normalizeDisplayEstimateMinutes = (minutes: number): number => {
...
export const OBSERVABILITY_CATEGORY_ORDER = ['monitoring_collection', 'monitoring_visualization', 'log_search', 'agent', 'trace_layer']
