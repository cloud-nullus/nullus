#!/usr/bin/env bash
# =============================================================================
# [DEPRECATED] 백엔드의 provisioning_sso 스텝이 이 역할을 대체합니다.
#
# 이 스크립트는 client secret 을 리터럴로 push 하므로 OpenBao 가 Source of
# Truth 라는 원칙과 어긋납니다. 백엔드 경로는 Nullus 가 생성해 OpenBao 에
# 기록한 값을 Keycloak 에 push 합니다.
#
# 대체: ./29-install-stacks-via-api.sh (백엔드 파이프라인이 SSO 까지 수행)
# =============================================================================
