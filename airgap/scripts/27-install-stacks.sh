#!/usr/bin/env bash
# =============================================================================
# [DEPRECATED] 백엔드를 우회하는 설치 경로입니다.
#
# 이 스크립트는 helm 을 직접 호출해 Nullus 백엔드의 설치 파이프라인을 건너뜁니다.
# 그 결과 OpenBao init/unseal, Kubernetes Auth, ESO 주입, 시크릿 프로비저닝,
# SSO 등록이 수행되지 않아 일반 설치와 다른 결과가 나옵니다.
#
# 대체: ./29-install-stacks-via-api.sh
# =============================================================================
