...
| **DevOps Engineer** | DevOps/Platform Engineer | DevSecOps 스택 구성, 배포, 운영 | 데브섹옵스 스택 > 스택 설치 |
...
| 2 | Pipeline Tools | CI/CD Platform (GitLab CI / GitHub Actions / Jenkins), CD Tool (Argo CD / Flux) |
| 3 | Monitoring Tools | Collection (Prometheus / Thanos), Visualization (Grafana) |
| 4 | Logging Tools | Collection (OpenTelemetry / Loki), Query & Search (OpenSearch) |
| 5 | Resources | 개발자 수, 동시 러너 수, 커밋 수, 빌드 빈도 입력 -> 자동 계산 |
