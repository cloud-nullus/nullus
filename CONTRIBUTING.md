...
- [ ] 문서 동기화 완료 (필수)
  - 기능 추가/변경/삭제 시 관련 문서를 반드시 함께 갱신
  - 최소 갱신 대상: `README.md`, `CHANGELOG.md`, 기능별 운영/가이드 문서(`docs/`)
  - API/스키마/환경변수/포트/실행 명령이 바뀌면 관련 섹션을 모두 동기화
  - 문서 갱신이 불필요한 경우 PR 본문에 "왜 불필요한지"를 명시
